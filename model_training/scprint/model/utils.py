...
def test(model: torch.nn.Module, name: str, filedir: str) -> None:
    ...
    Returns:
        None
    """
    # FIXME: add scRNA support for current model
    metrics = {}
    ...
    # FIXME: disable benchmarks which we lacks the datasets
    # FIXME: see issue https://github.com/cantinilab/scPRINT/issues/12
    """
    gc.collect()
